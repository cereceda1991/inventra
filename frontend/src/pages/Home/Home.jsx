...
const Home = () => {
  ...
  const description2="Úsalo desde cualquier dispositivo y desde cualquier lugar, Inventra siempre estará ahí para ti."
    ...
    <div className="home">
      ...
      <section className="home_main">
        ...
        <section className="home_content">
          ...
          <button className="home__button">COMENZAR AHORA</button>
        </section>
      </section>
    </div>
  );
